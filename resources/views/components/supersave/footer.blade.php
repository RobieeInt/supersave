    ...
    <div class="container">
            ...
            <div class="col-xl-3 col-lg-3 col-sm-6 md-mb-50px sm-mb-30px xs-mb-0 order-sm-2 order-lg-5">
                ...
                <div class="d-inline-block w-100 newsletter-style-02 position-relative">
                    <form action="email-templates/subscribe-newsletter.php" method="post" class="position-relative">
                        ...
                        <button class="btn pe-20px submit lh-16" aria-label="submit"><i
                                class="feather icon-feather-mail icon-small text-dark-gray"></i></button>
                        <div
        ...
        <div class="row justify-content-center align-items-center pt-2">
            ...
            <div
                ...
                <p>&copy; 2024 Supersave by <a href="https://robbyhernowo.com/" target="_blank"
                        class="text-dark-gray fw-600 text-decoration-line-bottom">Yujang</a></p>
            </div>
            <!-- end copyright -->
            <!-- start footer menu -->
