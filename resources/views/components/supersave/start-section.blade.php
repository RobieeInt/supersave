    ...
    <div class="container">
        <div class="row justify-content-center align-items-center mb-6 sm-pb-9">
            <div class="col-lg-6 col-md-9 position-relative md-mb-15 text-center text-lg-start"
                ...
                <div class="absolute-middle-center z-index-9 counter-style-02 text-center">
                    <span
                        class="fs-160 fw-800 text-dark-gray ls-minus-10px xs-ls-minus-5px position-relative lg-fs-130 xs-fs-75">28<sub
            ...
            <div class="col-lg-6 ps-6 text-center text-lg-start lg-ps-15px"
                ...
                <span
                    class="ps-25px pe-25px mb-20px text-uppercase text-base-color fs-14 lh-42px fw-700 border-radius-100px bg-gradient-very-light-gray-transparent d-inline-block">Creative
                    approach</span>
                ...
                <p class="w-80 xl-w-90 lg-w-100 mb-40px sm-mb-25px">
                    Kami berkomitmen untuk mengembangkan solusi energi surya yang ideal bagi berbagai proyek, mulai dari
                    skala kecil hingga besar, dengan kebutuhan yang khusus. Kami menawarkan desain sistem panel surya
                    yang efisien dan sesuai dengan kebutuhan spesifik Anda, serta memastikan performa optimal untuk
                    mencapai target penghematan energi Anda.
                </p>
                ...
                <span class="text-dark-gray fw-700 ls-minus-05px d-block d-sm-inline-block sm-mt-15px"><a
                        href="tel:1800222000"><i class="feather icon-feather-phone-call me-10px"></i>1 800
                        222 000</a></span>
            </div>
        </div>
        <div class="row row-cols-1 row-cols-md-4 row-cols-sm-2 justify-content-center counter-style-07 ps-3 pe-3"
            ...
            <div class="col text-center sm-mb-30px">
                ...
                <span class="d-block fs-14 fw-700 text-uppercase text-dark-gray">Project</span>
            </div>
            <!-- end counter item -->
            <!-- start counter item -->
