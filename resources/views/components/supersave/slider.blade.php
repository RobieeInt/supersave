    ...
    <div class="demo-corporate-slider_wrapper fullscreen-container" data-alias="portfolio-viewer" data-source="gallery"
        ...
        <div id="demo-corporate-slider" class="rev_slider bg-regal-blue fullscreenbanner" style="display:none;"
            ...
            <ul>
                ...
                <li data-index="rs-01" data-transition="parallaxleft" data-slotamount="default" data-hideafterloop="0"
                    data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="1500"
                    data-rotate="0" data-saveperformance="off" data-title="Crossfit" data-param1="" data-param2=""
                    data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
                    data-param9="" data-param10="" data-description="">
                    <!-- slide's main background image -->
                    <img src="{{ asset('supersave/bg/solar-panel-bg.jpg') }}" alt="Image"
                        ...
                        <div class="tp-caption  " id="slide-1-layer-04" data-x="['left','left','left','left']"
                            ...
                            <div class="tp-caption" id="slide-1-layer-05" data-x="['left','left','left','left']"
                                ...
                                <div class="tp-caption mx-auto" id="slide-1-layer-07"
                                    ...
                                    Awesome solutions for energy saving
                                </div>
                                <!-- end title layer -->
                                <!-- start text layer -->
                                <div class="tp-caption mx-auto" id="slide-1-layer-08"
                                    ...
                                    data-paddingleft="[0,0,0,0]">
                                    We're a fully support for your energy saving solutions. We're a fully dedicated
                                </div>
                                <!-- end text layer -->
                                <!-- start button layer -->
                ...
                <li data-index="rs-02" data-transition="parallaxleft" data-slotamount="default"
                    ...
                    <!-- slide's main background image -->
                    <img src="{{ asset('supersave/bg/solar-panel-bg-1.jpg') }}" alt="Image"
                        ...
                        <div class="tp-caption  " id="slide-2-layer-04" data-x="['left','left','left','left']"
                            ...
                            <div class="tp-caption" id="slide-2-layer-05" data-x="['left','left','left','left']"
                                ...
                                <div class="tp-caption mx-auto" id="slide-2-layer-08"
                                    ...
                                    data-paddingright="[0,0,0,0]" data-paddingbottom="[36,36,60,40]"
                                    data-paddingleft="[0,0,0,0]">
                                    We're a fully dedicated corporate service for energy saving.
                                </div>
                                <!-- end text layer -->
                                <!-- start button layer -->
                ...
                <li data-index="rs-03" data-transition="parallaxleft" data-slotamount="default"
                    ...
                    data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    <!-- slide's main background image -->
                    <img src="{{ asset('supersave/bg/solar-panel-bg-2.webp') }}" alt="Image"
                        data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                        class="rev-slidebg" data-no-retina>
                    <!-- start overlay layer -->
