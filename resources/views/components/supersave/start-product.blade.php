<section class="overflow-hidden bg-regal-blue position-relative border-radius-6px lg-border-radius-0px z-index-0">
    <img src="{{ asset('supersave/bg/solar-panel-bg.jpg') }}"
        ...
        data-bottom-top="transform: rotate(0deg) translateY(0)" data-top-bottom="transform:rotate(-20deg) translateY(0)"
        alt="" />
    <div class="container">
        <div class="row align-items-center mb-6 sm-mb-9 text-center text-lg-start">
            <div class="col-lg-5 md-mb-20px">
                <span
                    class="ps-25px pe-25px mb-10px text-uppercase text-white fs-13 lh-42px fw-600 border-radius-100px bg-gradient-blue-whale-transparent d-inline-block">Creative
                    approach</span>
            ...
            <div class="col-lg-5 last-paragraph-no-margin md-mb-20px">
                <p class="w-85 md-w-100">
                    Kami berkomitmen untuk mengembangkan solusi energi surya yang ideal untuk proyek skala kecil hingga
                    besar, sesuai dengan kebutuhan khusus proyek Anda.
                </p>
            </div>
        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <div class="fs-18 text-white d-inline-block align-middle">
                    ...
                    <a href="demo-corporate-contact.html" class="text-white text-decoration-line-bottom">Contact us
                        now</a>
                </div>
            </div>
        </div>
