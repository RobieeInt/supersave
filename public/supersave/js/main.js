...
(function ($) {
    ...
    $(".nav-item  .nav-link").on("click", function (e) {
        var submenuLenth = $(this)
            .closest(".dropdown")
            .find(".dropdown").length;

        if (
            $(window).width() < 992 &&
            $(this).closest(".dropdown").length > 0
        ) {
            var HasClass = $(this)
                .closest(".nav-item")
                .find(".dropdown-menu")
